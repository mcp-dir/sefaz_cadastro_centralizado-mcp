...
SEFAZ: Cadastro Centralizado de Contribuinte (CCC) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_cadastro_centralizado@mcp.ai](mailto:sefaz_cadastro_centralizado@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
